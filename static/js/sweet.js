! function(t, e) {
  ...
  function y(t, e, n) {
    if (function(e) {
        m(e.classList).forEach(function(t) {
          -1 === f(x).indexOf(t) && -1 === f(A).indexOf(t) && e.classList.remove(t)
        })
      }(t), e && e[n]) {
  ...
  var e = "SweetAlert2:",
    ...
    x = t(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "toast", "toast-shown", "toast-column", "show", "hide", "close", "title", "header", "content", "actions", "confirm", "cancel", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl"]),
  ...
  function G() {
    return !st() && !document.body.classList.contains(x["no-backdrop"])
  }
        ...
        n.appendChild(e),
          ...
          function() {
            var t = F(),
              ...
              u = ut(t, x.textarea);
            e.oninput = et, n.onchange = et, r.onchange = et, a.onchange = et, u.oninput = et, o.oninput = function(t) {
  ...
  function mt(t, e) {
    ...
    }(n, e.grow), y(n, e.customClass, "container"))
  }
  ...
  var gt = {
    ...
    bt = function(t) {
      if (!kt[t.input]) return h('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(t.input, '"'));
      var e = Ct(t.input),
        n = kt[t.input](e, t);
  ...
  kt.text = kt.email = kt.password = kt.number = kt.tel = kt.url = function(t, e) {
    return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : v(e.inputValue) || w('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), ht(t, e), t.type = e.input, t
  ...
  function Pt(t, e) {
    var n = Q();
    y(n, e.customClass, "header"), At(0, e),
      function(t, e) {
        var n = gt.innerParams.get(t);
        if (n && e.icon === n.icon && N()) y(N(), e.customClass, "icon");
        else if (Tt(), e.icon)
          if (-1 !== Object.keys(A).indexOf(e.icon)) {
            var o = I(".".concat(x.icon, ".").concat(A[e.icon]));
            L(o), Lt(o, e), Et(), y(o, e.customClass, "icon"), rt(o, e.showClass.icon)
          } else h('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"'))
      }(t, e),
      function(t, e) {
        var n = _();
        if (!e.imageUrl) return O(n);
        L(n), n.setAttribute("src", e.imageUrl), n.setAttribute("alt", e.imageAlt), E(n, "width", e.imageWidth), E(n, "height", e.imageHeight), n.className = x.image, y(n, e.customClass, "image")
      }(0, e),
      function(t, e) {
        var n = U();
  ...
  function Bt(t, e) {
    ! function(t, e) {
      var n = R();
      E(n, "width", e.width), E(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = x.popup, e.toast ? (rt([document.documentElement, document.body], x["toast-shown"]), rt(n, x.toast)) : rt(n, x.modal), y(n, e.customClass, "popup"), "string" == typeof e.customClass && rt(n, e.customClass)
  ...
  var Tt = function() {
    ...
    Lt = function(t, e) {
      if (t.innerHTML = "", e.iconHtml) t.innerHTML = Ot(e.iconHtml);
  ...
  function Mt() {
    ...
    var e = Z(),
      n = K();
    L(e), L(n), rt([t, e], x.loading), n.disabled = !0, t.setAttribute("data-loading", !0), t.setAttribute("aria-busy", !0), t.focus()
  }
  ...
  var It = [],
    ...
    Dt = ["title", "titleText", "text", "html", "type", "customClass", "showConfirmButton", "showCancelButton", "confirmButtonText", "confirmButtonAriaLabel", "confirmButtonColor", "cancelButtonText", "cancelButtonAriaLabel", "cancelButtonColor", "buttonsStyling", "reverseButtons", "imageUrl", "imageWidth", "imageHeigth", "imageAlt", "progressSteps", "currentProgressStep"],
    Nt = {
    ...
    Ft = Object.freeze({
      ...
      mixin: function(n) {
        return function(t) {
          ...
          return function(t, e) {
            ...
            key: "_main",
            value: function(t) {
              return p(s(e.prototype), "_main", this).call(this, u({}, n, t))
            }
          }]), e
        }(this)
      },
      queue: function(t) {
        ...
        function a(t, e) {
          It = [], document.body.removeAttribute("data-swal2-queue-step"), t(e)
        }
        var u = [];
      ...
      stopTimer: function() {
        return qt.timeout && qt.timeout.stop()
      },
      resumeTimer: function() {
        return qt.timeout && qt.timeout.start()
      },
      ...
      increaseTimer: function(t) {
        return qt.timeout && qt.timeout.increase(t)
      },
  ...
  function Qt(t, e, n, o) {
    n ? Gt(t, o) : (Ht().then(function() {
      return Gt(t, o)
    }), qt.keydownTarget.removeEventListener("keydown", qt.keydownHandler, {
      capture: qt.keydownListenerCapture
    }), qt.keydownHandlerAdded = !1), e.parentNode && e.parentNode.removeChild(e), G() && (null !== P.previousBodyPadding && (document.body.style.paddingRight = P.previousBodyPadding + "px", P.previousBodyPadding = null), function() {
      if (b(document.body, x.iosfix)) {
        var t = parseInt(document.body.style.top, 10);
        at(document.body, x.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * t
      }
    }(), "undefined" != typeof window && Wt() && window.removeEventListener("resize", Kt), m(document.body.children).forEach(function(t) {
  ...
  var Xt = function(t, e, n, o) {
      qt.swalCloseEventFinishedCallback = Qt.bind(null, t, n, st(), o), e.addEventListener(pt, function(t) {
    ...
    Gt = function(t, e) {
      setTimeout(function() {
        null !== e && "function" == typeof e && e(), R() || function(t) {
          delete t.params, delete qt.keydownHandler, delete qt.keydownTarget, Jt(gt), Jt(Zt)
        }(t)
      })
    };
  ...
  function ie(t) {
    ! function(e) {
      e.inputValidator || Object.keys(oe).forEach(function(t) {
        e.input === t && (e.inputValidator = oe[t])
      })
  ...
  function re(t, e) {
    t.removeEventListener(pt, re), e.style.overflowY = "auto"
  }

  function ae(t) {
    var e = j(),
      n = R();
    "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), ge(e, n, t), me(e, n), G() && he(e, t.scrollbarPadding), st() || qt.previousActiveElement || (qt.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() {
      return t.onOpen(n)
    })
  }

  function ue(t, e) {
    "select" === e.input || "radio" === e.input ? we(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && v(e.inputValue) && Ce(t, e)
  }

  function se(t, e) {
    t.disableButtons(), e.input ? Ae(t, e) : Pe(t, e, !0)
  }
  ...
  function fe(t, e, n) {
    e.toast ? He(t, e, n) : (je(t), Ie(t), qe(t, e, n))
  }
  var me = function(t, e) {
      pt && V(e) ? (t.style.overflowY = "hidden", e.addEventListener(pt, re.bind(null, e, t))) : t.style.overflowY = "auto"
    },
    he = function(t, e) {
      ! function() {
        if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !b(document.body, x.iosfix)) {
          ...
          document.body.style.top = -1 * t + "px", rt(document.body, x.iosfix), Yt()
        }
      }(), "undefined" != typeof window && Wt() && (Kt(), window.addEventListener("resize", Kt)), m(document.body.children).forEach(function(t) {
        t === j() || function(t, e) {
      ...
      }), e && zt(), setTimeout(function() {
        t.scrollTop = 0
      })
    },
    ge = function(t, e, n) {
      rt(e, n.showClass.popup), rt(t, n.showClass.backdrop), L(e), rt([document.documentElement, document.body], x.shown), n.heightAuto && n.backdrop && !n.toast && rt([document.documentElement, document.body], x["height-auto"])
    },
    ve = function(t) {
    ...
    we = function(e, n) {
      function o(t) {
        return ke[n.input](i, xe(t), n)
      }
      var i = F();
      v(n.inputOptions) ? (Mt(), n.inputOptions.then(function(t) {
        e.hideLoading(), o(t)
    ...
    Ce = function(e, n) {
      ...
      O(o), n.inputValue.then(function(t) {
        ...
        h("Error in inputValue promise: " + t), o.value = "", L(o), o.focus(), e.hideLoading()
      })
    },
    ke = {
      ...
      radio: function(t, e, a) {
        ...
        e.forEach(function(t) {
          ...
          r.innerHTML = n, r.className = x.label, i.appendChild(o), i.appendChild(r), u.appendChild(i)
        });
    ...
    Ae = function(e, n) {
      ...
      n.inputValidator ? (e.disableInput(), Promise.resolve().then(function() {
        ...
        e.enableButtons(), e.enableInput(), t ? e.showValidationMessage(t) : Pe(e, n, o)
      })) : e.getInput().checkValidity() ? Pe(e, n, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage))
    },
    Pe = function(e, t, n) {
      (t.showLoaderOnConfirm && Mt(), t.preConfirm) ? (e.resetValidationMessage(), Promise.resolve().then(function() {
        ...
        H(W()) || !1 === t ? e.hideLoading() : le(e, void 0 === t ? n : t)
      })) : le(e, n)
    },
    Be = ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"],
    Se = ["Escape", "Esc"],
    Te = function(t, e, n, o) {
      n.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? Ee(t, e, n) : "Tab" === e.key ? Le(e, n) : -1 !== Be.indexOf(e.key) ? Oe() : -1 !== Se.indexOf(e.key) && Me(e, n, o)
    },
    Ee = function(t, e, n) {
    ...
    Le = function(t, e) {
      for (var n = t.target, o = X(), i = -1, r = 0; r < o.length; r++)
        if (n === o[r]) {
          i = r;
          break
        } t.shiftKey ? pe(0, i, -1) : pe(0, i, 1), t.stopPropagation(), t.preventDefault()
    },
    Oe = function() {
      var t = K(),
        e = Y();
      document.activeElement === t && H(e) ? e.focus() : document.activeElement === e && H(t) && t.focus()
    },
    Me = function(t, e, n) {
    ...
    je = function(e) {
      e.popup.onmousedown = function() {
        e.container.onmouseup = function(t) {
          e.container.onmouseup = void 0, t.target === e.container && (Ve = !0)
        }
      }
    },
    Ie = function(e) {
      e.container.onmousedown = function() {
        e.popup.onmouseup = function(t) {
          e.popup.onmouseup = void 0, t.target !== e.popup && !e.popup.contains(t.target) || (Ve = !0)
        }
      }
    },
    qe = function(e, n, o) {
      e.container.onclick = function(t) {
        Ve ? Ve = !1 : t.target === e.container && C(n.allowOutsideClick) && o(k.backdrop)
      }
    };
  var Re = function(t, e, n) {
      e.timer && (t.timeout = new ne(function() {
        n("timer"), delete t.timeout
      }, e.timer))
    },
    De = function(t, e) {
      if (!e.toast) return C(e.allowEnterKey) ? e.focusCancel && H(t.cancelButton) ? t.cancelButton.focus() : e.focusConfirm && H(t.confirmButton) ? t.confirmButton.focus() : void pe(0, -1, 1) : Ne()
    },
    Ne = function() {
      document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()
    };
  var Ue, Fe = Object.freeze({
    hideLoading: _t,
    disableLoading: _t,
    getInput: function(t) {
    ...
    showValidationMessage: function(t) {
      ...
      var o = this.getInput();
      o && (o.setAttribute("aria-invalid", !0), o.setAttribute("aria-describedBy", x["validation-message"]), S(o), rt(o, x.inputerror))
    },
    ...
    _main: function(t) {
      ! function(t) {
        for (var e in t) Vt(i = e) || w('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== Ut.indexOf(o) && w('The parameter "'.concat(o, '" is incompatible with toasts'))), jt(n = e) && g(n, jt(n));
        var n, o, i
      }(t), R() && qt.swalCloseEventFinishedCallback && (qt.swalCloseEventFinishedCallback(), delete qt.swalCloseEventFinishedCallback), qt.deferDisposalTimer && (clearTimeout(qt.deferDisposalTimer), delete qt.deferDisposalTimer);
      var e = function(t) {
        var e = u({}, Rt.showClass, t.showClass),
          n = u({}, Rt.hideClass, t.hideClass),
          o = u({}, Rt, t);
      ...
      ie(e), Object.freeze(e), qt.timeout && (qt.timeout.stop(), delete qt.timeout), clearTimeout(qt.restoreFocusTimeout);
      var n = function(t) {
        var e = {
          popup: R(),
          container: j(),
      ...
      return Bt(this, e), gt.innerParams.set(this, e),
        function(n, o, i) {
          return new Promise(function(t) {
            var e = function t(e) {
              n.closePopup({
    ...
    update: function(e) {
      ...
      if (!t || b(t, n.hideClass.popup)) return w("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
      var o = {};
      Object.keys(e).forEach(function(t) {
        ze.isUpdatableParameter(t) ? o[t] = e[t] : w('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
      });
      var i = u({}, n, o);
      Bt(this, i), gt.innerParams.set(this, i), Object.defineProperties(this, {
        params: {
  ...
  function _e() {
    if ("undefined" != typeof window) {
      "undefined" == typeof Promise && h("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), Ue = this;
      for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
